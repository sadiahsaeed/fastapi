...
from utils import process_file_by_extension, QdrantInsertRetrievalAll, Conversational_Retrieval
...
collection_name = "testing_url_memory"
...
async def process_urls(url_list: UrlList, chatbot_id:str):
